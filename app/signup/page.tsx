        ...
        <div className="mt-20 flex justify-center px-6 pb-16 sm:mt-32 sm:px-0">
            <div className="max-w-md  w-1/3">                
                ...
                <form className="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <button
                        type="submit"
                        className="flex w-full justify-center rounded-md border border-transparent bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-400 focus:outline-none disabled:bg-blue-500 disabled:opacity-40"
